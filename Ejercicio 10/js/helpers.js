...
function muestraContenido() {
  ...
  document.getElementById("contenidoAjax").innerHTML =  JSON.stringify(JSON.parse(this.req.responseText), null, " ");

  // EN LA CONSOLA SE VE MEJOR :)
  console.log(JSON.stringify(JSON.parse(this.req.responseText), null, " "));

  
  //document.getElementById("contenidoAjax").innerHTML = JSON.parse(this.req.responseText);
   // document.getElementById("contenidoAjax").innerHTML = JSON.stringify(JSON.parse(this.req.responseText));
}
/**
